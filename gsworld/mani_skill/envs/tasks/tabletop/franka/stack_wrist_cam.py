...
from gsworld.mani_skill.agents.robots.panda.fr3_umi_wrist435_modified import Fr3UmiWrist435Modified
...
from gsworld.mani_skill.envs.tasks.real_fr3_wrist_cam_env import RealFr3WristCam
...
class StackFr3WristCamEnv(RealFr3WristCam):
    ...
    SUPPORTED_ROBOTS = ["fr3_umi_wrist435_modified"]
    agent: Union[Fr3UmiWrist435Modified]
    goal_thresh = 0.025
